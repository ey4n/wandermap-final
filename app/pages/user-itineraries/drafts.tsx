...
import { MantineProvider, useMantineTheme, Title, Button, Burger } from '@mantine/core';
      ...
      <div style={{ display: 'flex' }}>
         ...
         */}
         <div style={{ height: "100vh", backgroundColor: theme.colors["pastel-purple"][1] }}>
          ...
          {opened && (
            <div style={{ height: "100vh", backgroundColor: theme.colors["pastel-purple"][1], flex: 1 }}>
              <Navlink></Navlink>
            </div>
          )}
        </div>
